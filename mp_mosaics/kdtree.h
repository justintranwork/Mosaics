...
class KDTree
{
  ...
  private:
     ...
     */
    //Helper function that erases the subroots then the original root
    void obliterate(KDTreeNode * subroot);
    //Copy helper function
    void copy(KDTreeNode * copyOnto, KDTreeNode * original);
    //Constructor helper function
    KDTree<Dim>::KDTreeNode* makeTree(vector<Point<Dim>>& points_, int dimension, unsigned left, unsigned right);
    //Quickselect for constructor
